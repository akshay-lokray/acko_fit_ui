    ...
    <div className="min-h-screen bg-white relative flex flex-col items-center justify-center p-6 font-sans">
      ...
      <div className="text-center space-y-4 mb-12 relative z-10 max-w-2xl animate-fade-in-up">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-900">
          Choose Your <span className="text-purple-700"> Fitness Coach</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl px-4 relative z-10">
        {coaches.map((coach) => (
          ...
          >
            ...
            >
              <div
                className={`p-4 rounded-xl ${coach.bgColor} transition-transform duration-300 group-hover:scale-110`}
              >
                {coach.icon}
              </div>
              ...
              <div className="space-y-1">
                ...
                <p
                  className={`text-sm font-bold uppercase tracking-wide ${coach.themeColor}`}
                >
                  {coach.role}
                </p>
              </div>
              ...
              >
                ...
                <ArrowRight
                  className={`ml-2 h-5 w-5 transition-transform duration-300 ${
                    hovered === coach.id ? "translate-x-1" : ""
                  }`}
                />
              </Button>
            </Card>
